 ...
 * @version $Id$
 */
public class InformationContentFeatureSimilarityScorerTest
{
    @Rule
    public final MockitoComponentMockingRule<FeatureSimilarityScorer> mocker =
        new MockitoComponentMockingRule<FeatureSimilarityScorer>(InformationContentFeatureSimilarityScorer.class);
    ...
    public void testEqualValues() throws ComponentLookupException
    {
        ...
        Assert.assertEquals(0.55, this.mocker.getComponentUnderTest().getScore(match, reference), 0.5);
    }
    ...
    public void testDifferentValues() throws ComponentLookupException
    {
        ...
        Assert.assertEquals(0.0, this.mocker.getComponentUnderTest().getScore(match, reference), 0.1);
    }
    ...
    public void testFarRelatedValues() throws ComponentLookupException
    {
        ...
        Assert.assertEquals(0.3, this.mocker.getComponentUnderTest().getScore(match, reference), 0.2);
    }
    ...
    public void testTooFarRelatedValues() throws ComponentLookupException
    {
        ...
        Assert.assertEquals(0, this.mocker.getComponentUnderTest().getScore(match, reference), 0.1);
    }
