...
public class DefaultPhenotypesMap extends AbstractMap<String, List<Map<String, String>>> implements PhenotypesMap
{
     ...
     * @param predefined2 list of predefined phenotypes for another patient
     **/
    public static void reorder(Collection<Feature> predefined1, Collection<Feature> predefined2)
    {
        List<Feature> predefined1Copy = new ArrayList<>(predefined1);
        List<Feature> predefined2Copy = new ArrayList<>(predefined2);

        Map<String, Feature> predefined1Map = constructMap2(predefined1Copy);
        Map<String, Feature> predefined2Map = constructMap2(predefined2Copy);
